...
part of 'animal_write_dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AnimalWriteDto _$AnimalWriteDtoFromJson(Map<String, dynamic> json) => AnimalWriteDto(
  ...
  images: (json['images'] as List<dynamic>?)
      ?.map((e) => AnimalImageWriteDto.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$AnimalWriteDtoToJson(AnimalWriteDto instance) => <String, dynamic>{
  'name': instance.name,
