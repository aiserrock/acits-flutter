...
UserAdminWriteDto _$UserAdminWriteDtoFromJson(Map<String, dynamic> json) => UserAdminWriteDto(
  ...
  shelter: ShelterWriteDto.fromJson(json['shelter'] as Map<String, dynamic>),
  fathersName: json['fathers_name'] as String?,
  phoneNumber: json['phone_number'] as String?,
  address: json['address'] as String?,
);

Map<String, dynamic> _$UserAdminWriteDtoToJson(UserAdminWriteDto instance) => <String, dynamic>{
