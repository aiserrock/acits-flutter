...
AnimalShortDto _$AnimalShortDtoFromJson(Map<String, dynamic> json) => AnimalShortDto(
...
Map<String, dynamic> _$AnimalShortDtoToJson(AnimalShortDto instance) => <String, dynamic>{
  'id': instance.id,
  'uuid': instance.uuid,
  'name': instance.name,
