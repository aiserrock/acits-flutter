...
import '../service/animal/animal_service.dart' as _i12;
...
import '../service/prescription/prescription_service.dart' as _i10;
import '../service/staff/staff_service.dart'
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i11.StaffService>(
      _i11.StaffService(get<_i7.AuthService>(), get<_i4.Openapi>()));
  gh.singleton<_i12.AnimalService>(
      _i12.AnimalService(get<_i7.AuthService>(), get<_i4.Openapi>()));
  return get;
}
