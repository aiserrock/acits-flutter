...
> Дата: 2026-07-12. Источники паттернов: a large production app (банк-монорепо), a production driver app + a shared library set,
> экосистема a production monorepo (a seller app, a production app, a reusable CI template, a fastlane setup),
> a banking app. Каждый пункт верифицирован против реального кода этого репозитория —
...
Источники: a large production app, a banking app. **Замерено на живом коде.**
...
Источник: a production driver app, **с коррекцией — 1:1 копировать нельзя**:
...
Источники: a banking app, a production driver app, a large production app.
...
Источники: a production driver app, a production ecosystem.
...
Источник: a production ecosystem, **со сменой инструмента**:
