...
///
/// [PrescriptionRepository] и UI-табы показывают имя типа по его wire-значению
...
///
/// [ensureLoaded] прогревает серверный конфиг, если он ещё не загружен
/// (репозиторий вызывает его перед выборками, как раньше делал
/// `ConfigService.getTypeValues`).
