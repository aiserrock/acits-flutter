...
import 'package:app_services/src/service/auth/email_confirm_repository.dart'
    as _i672;
import 'package:app_services/src/service/client/acits_api_register.dart'
    as _i472;
import 'package:app_services/src/service/client/animals_port_bridges.dart'
    as _i694;
import 'package:app_services/src/service/client/animals_register.dart' as _i121;
import 'package:app_services/src/service/client/applicants_register.dart'
    as _i14;
import 'package:app_services/src/service/client/auth_port_bridges.dart'
    as _i299;
...
import 'package:app_services/src/service/client/personal_register.dart'
    as _i118;
import 'package:app_services/src/service/client/prescriptions_register.dart'
    as _i68;
...
import 'package:app_services/src/service/document/document_export_service_bridge.dart'
    as _i11;
...
import 'package:app_services/src/service/link_handler/deep_link_service.dart'
    as _i542;
import 'package:app_services/src/service/secure_storage/secure_storage_register.dart'
    as _i922;
import 'package:app_services/src/service/shared_pref/preference_storage.dart'
    as _i614;
import 'package:app_services/src/service/shared_pref/shared_pref_register.dart'
    as _i100;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) async {
    ...
    gh.factory<_i372.SessionInvalidator>(
        () => const _i299.AuthServiceSessionInvalidator());
    gh.factory<_i249.PdfjsReadyPort>(() => const _i428.AppPdfjsReady());
    gh.factory<_i372.TokenRefresher>(
        () => const _i299.AuthServiceTokenRefresher());
    gh.factory<_i609.DocumentExportService>(
        () => _i11.DocumentExportServiceBridge());
    gh.factory<_i249.DocExporterPort>(() => _i428.AppDocExporter());
    gh.factory<_i372.LocaleProvider>(
        () => const _i299.ConfigServiceLocaleProvider());
    gh.factory<_i372.TokenStore>(() => const _i299.AuthServiceTokenStore());
    gh.factory<_i358.AuthRepository>(
        () => _i358.AuthRepository(gh<_i558.FlutterSecureStorage>()));
    gh.factory<_i520.ThemeStorage>(
        () => _i520.ThemeStorage(gh<_i558.FlutterSecureStorage>()));
    gh.singleton<_i64.DebugService>(
      () => _i64.DebugService(),
      registerFor: {_prod},
    );
    ...
    gh.factory<_i417.Env>(
      () => envRegistrer.createEnv(),
      registerFor: {_prod},
    );
    gh.factory<_i672.EmailConfirmRepository>(
        () => _i672.EmailConfirmRepository(gh<_i361.Dio>()));
    gh.factory<_i530.FileRepository>(
        () => _i530.FileRepository(gh<_i361.Dio>()));
    gh.factory<_i361.Dio>(
    ...
    gh.factory<_i589.FileService>(
        () => _i589.FileService(gh<_i530.FileRepository>()));
    gh.factory<_i995.SheltersClient>(
      () => acitsApiRegister
          .sheltersClient(gh<_i361.Dio>(instanceName: 'acitsApiGuest')),
      registerFor: {_prod},
    );
    ...
    gh.factory<_i995.AnimalsClient>(
      () => acitsApiRegister
          .animalsClient(gh<_i361.Dio>(instanceName: 'acitsApi')),
      registerFor: {_prod},
    );
    ...
    gh.factory<_i995.PrescriptionsClient>(
      () => acitsApiRegister
          .prescriptionsClient(gh<_i361.Dio>(instanceName: 'acitsApi')),
      registerFor: {_prod},
    );
    gh.factory<_i995.ApplicantsClient>(
      () => acitsApiRegister
          .applicantsClient(gh<_i361.Dio>(instanceName: 'acitsApi')),
      registerFor: {_prod},
    );
    gh.factory<_i995.CuratorsClient>(
      () => acitsApiRegister
          .curatorsClient(gh<_i361.Dio>(instanceName: 'acitsApi')),
      registerFor: {_prod},
    );
    ...
    gh.factory<_i995.SheltersClient>(
      () => acitsApiRegister
          .sheltersClientAuthed(gh<_i361.Dio>(instanceName: 'acitsApi')),
      instanceName: 'acitsApiSheltersAuthed',
      registerFor: {_prod},
    );
    gh.factory<_i995.TokenClient>(
      () => acitsApiRegister
          .tokenClientAuthed(gh<_i361.Dio>(instanceName: 'acitsApi')),
    ...
    gh.factory<_i1007.CommentFileOpener>(
        () => _i118.FileServiceCommentFileOpener(gh<_i589.FileService>()));
    ...
    gh.singleton<_i397.AuthService>(() => _i397.AuthService(
    ...
    gh.singleton<_i1007.PersonalService>(() => personalRegister.personalService(
