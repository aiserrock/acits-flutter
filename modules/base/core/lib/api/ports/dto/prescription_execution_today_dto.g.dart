...
PrescriptionExecutionTodayDto _$PrescriptionExecutionTodayDtoFromJson(
  Map<String, dynamic> json,
) => PrescriptionExecutionTodayDto(
  prescription: PrescriptionShortDto.fromJson(
...
Map<String, dynamic> _$PrescriptionExecutionTodayDtoToJson(
  PrescriptionExecutionTodayDto instance,
) => <String, dynamic>{
  'id': instance.id,
