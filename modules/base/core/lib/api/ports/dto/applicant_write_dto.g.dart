...
ApplicantWriteDto _$ApplicantWriteDtoFromJson(Map<String, dynamic> json) => ApplicantWriteDto(
...
Map<String, dynamic> _$ApplicantWriteDtoToJson(ApplicantWriteDto instance) => <String, dynamic>{
  'id': ?instance.id,
