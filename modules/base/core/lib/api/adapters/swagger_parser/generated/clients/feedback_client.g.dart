...
class _FeedbackClient implements FeedbackClient {
  _FeedbackClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<Feedback> v1FeedbackCreate({
    ...
    final _options = _setStreamType<Feedback>(
