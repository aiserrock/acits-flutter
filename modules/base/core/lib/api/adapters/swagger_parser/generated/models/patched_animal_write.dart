...
part 'patched_animal_write.g.dart';
...
class PatchedAnimalWrite {
  ...
  factory PatchedAnimalWrite.fromJson(Map<String, Object?> json) => _$PatchedAnimalWriteFromJson(json);
  ...
  Map<String, Object?> toJson() => _$PatchedAnimalWriteToJson(this);
}
