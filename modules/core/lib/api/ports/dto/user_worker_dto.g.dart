...
UserWorkerDto _$UserWorkerDtoFromJson(Map<String, dynamic> json) => UserWorkerDto(
...
Map<String, dynamic> _$UserWorkerDtoToJson(UserWorkerDto instance) => <String, dynamic>{
