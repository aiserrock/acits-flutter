...
PrescriptionDrugDto _$PrescriptionDrugDtoFromJson(Map<String, dynamic> json) => PrescriptionDrugDto(
...
Map<String, dynamic> _$PrescriptionDrugDtoToJson(PrescriptionDrugDto instance) => <String, dynamic>{
