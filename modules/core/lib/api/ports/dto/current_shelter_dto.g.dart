...
CurrentShelterDto _$CurrentShelterDtoFromJson(Map<String, dynamic> json) => CurrentShelterDto(
...
Map<String, dynamic> _$CurrentShelterDtoToJson(CurrentShelterDto instance) => <String, dynamic>{
