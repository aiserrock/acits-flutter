...
UserWorkerWriteDto _$UserWorkerWriteDtoFromJson(Map<String, dynamic> json) => UserWorkerWriteDto(
...
Map<String, dynamic> _$UserWorkerWriteDtoToJson(UserWorkerWriteDto instance) => <String, dynamic>{
