...
class _TokenClient implements TokenClient {
  _TokenClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<TokenObtainPair> tokenCreate({
    ...
    final _options = _setStreamType<TokenObtainPair>(
    ...
    late TokenObtainPair _value;
    try {
      _value = TokenObtainPair.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<TokenRefresh> tokenRefreshCreate({
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<TokenRefresh>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/token/refresh/',
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late TokenRefresh _value;
    try {
      _value = TokenRefresh.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
