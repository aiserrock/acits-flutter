...
part 'other_prescription.g.dart';
...
class OtherPrescription {
  ...
  factory OtherPrescription.fromJson(Map<String, Object?> json) => _$OtherPrescriptionFromJson(json);
  ...
  Map<String, Object?> toJson() => _$OtherPrescriptionToJson(this);
}
