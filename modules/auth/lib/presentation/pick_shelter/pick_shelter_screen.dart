...
import 'package:auth/presentation/pick_shelter/pick_shelter.dart';
...
class PickShelterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => PickShelterCubit(
        authService: authService,
        configService: configService,
        autoSelectSingle: autoSelectSingle,
        shelterList: shelterList,
      ),
      child: _PickShelterView(router: router, appLogoLeading: appLogoLeading),
    );
  }
}

class _PickShelterView extends StatefulWidget {
  const _PickShelterView({required this.router, required this.appLogoLeading});
...
class _PickShelterViewState extends State<_PickShelterView> {
  ...
  Future<void> _autoSelectSingle() async {
    ...
    if (picked && mounted) widget.router.toRoot();
  }
