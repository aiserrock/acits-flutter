...
import 'package:media/presentation/photo_editor/photo_editor.dart';
import 'package:media/presentation/photo_gallery/cubit/cubit.dart';
import 'package:media/presentation/photo_gallery/widget/widget.dart';
...
class PhotoGalleryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => PhotoGalleryCubit(repository, shelterProvider, animalId: animalId),
