...
/// заставляет Flutter резолвить семейство из ассетов ui_kit.
class IconRes {
  IconRes._();
  ...
  static const IconData animalFace = IconData(
    0xe900,
    fontFamily: _fontFamily,
    fontPackage: _package,
  );
  static const IconData applicant = IconData(
    0xe901,
    fontFamily: _fontFamily,
    fontPackage: _package,
  );
  ...
  static const IconData visibleOff = IconData(
    0xe90a,
    fontFamily: _fontFamily,
    fontPackage: _package,
  );
