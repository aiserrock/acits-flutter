...
import 'package:acits_flutter/service/client/auth_client_register.dart' as _i29;
...
Future<_i1.GetIt> $initDevGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i15.DebugService>(_i19.DebugDevService(get<_i10.PreferenceStorage>()),
      registerFor: {_dev});
  gh.singleton<_i20.PersonalService>(
      _i20.PersonalService(get<_i17.Openapi>(), get<_i16.AuthService>()));
  ...
  gh.singleton<_i22.StaffService>(_i22.StaffService(get<_i16.AuthService>(), get<_i13.Openapi>()));
  gh.singleton<_i23.AnimalService>(
      _i23.AnimalService(get<_i16.AuthService>(), get<_i17.Openapi>()));
  return get;
}
...
class _$ClientRegister extends _i29.ClientRegister {}
